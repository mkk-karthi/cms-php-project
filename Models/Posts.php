...
class Posts
{
    ...
    public static function get($where = [], $order_by = [], $page = 1, $limit = 0)
    {
        ...
        $sql = "SELECT id, title, content, image, created_at FROM posts";
    ...
    public static function first($where)
    {
        ...
        $sql = "SELECT id, title, content, image, created_at FROM posts WHERE $where_data";
        $result = DATABASE->query($sql);
    ...
    public static function update($data, $where)
    {
        ...
        $sql = "UPDATE posts SET $set_data WHERE $where_data";
    ...
    public static function delete($where)
    {
        ...
        $sql = "DELETE FROM posts WHERE $where_data";
